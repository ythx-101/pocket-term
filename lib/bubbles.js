...
/**
 * Claude Code / TUI spinner & ephemeral status rows.
 * Leading spinner glyph (stars, braille dots) + short rest — not body text.
...
export function isSpinnerLine(line) {
  ...
  return SPINNER_LINE_RE.test(s);
}

/**
 * Content line usable for full-redraw set-diff (not blank / frame / spinner).
