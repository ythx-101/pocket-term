...
/** Claude projects root; override via createStateManager({ allowedRoot }) or PT2_PROJECTS_ROOT. */
export const DEFAULT_ALLOWED_ROOT = path.join(os.homedir(), '.claude/projects');
